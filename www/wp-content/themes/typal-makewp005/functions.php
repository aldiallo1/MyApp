...
function makewp005_scripts() {
	...
	wp_enqueue_style('animate', get_template_directory_uri() . '/includes/animate.css');
	wp_enqueue_style('cta', get_template_directory_uri() . '/includes/cta.css');
	wp_enqueue_style('fontawesome', get_template_directory_uri().'/includes/font-awesome/css/font-awesome.css', array(), '4.0.3' );
